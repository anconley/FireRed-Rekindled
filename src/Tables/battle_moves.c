...
const struct BattleMove gBattleMoves[] =
{
	...
	[MOVE_DOUBLESLAP] =
	{
		.effect = EFFECT_DOUBLE_HIT, // FootToTheFace
		.power = 25, //FootToTheFace
		.type = TYPE_NORMAL,
		.accuracy = 100, //FootToTheFace
		.pp = 24,
		.secondaryEffectChance = 0,
		.target = MOVE_TARGET_SELECTED,
		.priority = 0,
	...
	[MOVE_TWINEEDLE] =
	{
		.effect = EFFECT_POISON_HIT, // CHECK_THIS_PLEASE
		.power = 30, // FootToTheFace 
		.type = TYPE_BUG,
		.accuracy = 100,
		.pp = 20,
	...
	{
		.effect = EFFECT_SPEED_DOWN_HIT,
		.power = 20, // FootToTheFace
		.type = TYPE_NORMAL,
		.accuracy = 100,
		.pp = 32,
		.secondaryEffectChance = 100, // FootToTheFace
		.target = MOVE_TARGET_SELECTED,
		.priority = 0,
		.flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED,
		.z_move_power = 100,
	...
	[MOVE_PSYWAVE] =
	{
		.effect = EFFECT_LEVEL_DAMAGE, // FootToTheFace
		.power = 1,
		.type = TYPE_PSYCHIC,
		.accuracy = 100,
		.pp = 15,
	...
	[MOVE_OUTRAGE] =
	{
		.effect = EFFECT_RECOIL, //FootToTheFace
		.power = 120,
		.type = TYPE_DRAGON,
		.accuracy = 100,
		.pp = 8,
	...
	[MOVE_GUNKSHOT] =
	{
		.effect = EFFECT_POISON_HIT, // FootToTheFace
		.power = 120,
		.type = TYPE_POISON,
		.accuracy = 100,
		.pp = 8,
